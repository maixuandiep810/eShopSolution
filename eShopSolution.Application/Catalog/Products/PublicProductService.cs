...
namespace eShopSolution.Application.Catalog.Products
{
    public class PublicProductService : IPublicProductService
    {
        ...
        public async Task<PageResult<ProductViewModel>> GetAllByCategoryId(GetPublicProductPagingRequest request)
        {
            ...
            return await GetAllByCategoryIdDetailProduct(query, request);
        }
        ...
        private async Task<PageResult<ProductViewModel>> GetAllByCategoryIdDetailProduct(IQueryable<DetailProduct> query, GetPublicProductPagingRequest request)
        {
            //3. Paging
